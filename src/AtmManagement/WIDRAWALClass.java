...
class Widrawal extends JFrame implements ActionListener{
	...
	try {
		...
		if(e.getSource()==b2) {
			...
			DataBase db=new DataBase();
					...
					JOptionPane.showMessageDialog(null, "Amount is widhdrawll Successfully!!!");
					new TFrame().setVisible(true);
					setVisible(false);
...
public class WIDRAWALClass {

	public static void main(String[] args) {
		Widrawal wd=new Widrawal();
	}
